...
ifeq ($(OPENMP_COMPILER), LLVM)
  ...
  export OPENMP_CXXFLAGS := -foffload-lto -O2 -fPIC -std=c++17 -fopenmp $(OPENMP_TARGETS) -fopenmp-offload-mandatory $(OPENMP_EIGEN_CXXFLAGS) --gcc-toolchain=$(GCC_TOOLCHAIN)
